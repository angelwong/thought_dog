Summary
Thought Dog is an open source educational software platform being developed as part of Columbia University's COMS W3101 - Ruby on Rails Course.

Homework 2 Notes
-Parts 1-3 complete.
-1 error in reference structure (see rails console code below)
Nathan = User.new(:name => "Nathan", :email => "nathan@gmail.com")
...
Nathan.courses << ROR
Nathan.uploads << my_submission
ROR.users << Nathan # !!! error here !!!
ROR.sections << Only
Only.users << Nathan
